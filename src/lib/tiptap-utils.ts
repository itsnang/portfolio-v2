...
export const handleImageUpload = async (
  ...
  try {
    ...
    // Upload using your server action (uploads to Cloudinary + saves to DB)
    const result = await uploadStagedFile(file, "editor-images");
    ...
    // Get the image URL from the database result
